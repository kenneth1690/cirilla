  ...
  Widget build(BuildContext context) {
    ...
    return Observer(
      builder: (_) {
        ...
        Map<String, dynamic>? addressFields = _addressDataStore.address?.billing;
        bool loading = _addressDataStore.loading != false && addressFields?.isNotEmpty != true;

        if (billing["country"] is String && billing["country"] != "" && !_addressDataStore.loading && _addressDataStore.address?.country != null && billing["country"] != _addressDataStore.address?.country) {
