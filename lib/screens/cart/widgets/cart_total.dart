      ...
      children: [
        ...
        ...List.generate(
          ...
          (index) {
            ...
            String? tax = get(cartData.coupons!.elementAt(index), ['totals', 'total_discount_tax'], '0');
            ...
            return Column(
              children: [
                ...
                buildCartTotal(
                  ...
                  price: '- ${convertCurrency(context, unit: unit, currency: currencyCode, price: _total(coupon, tax))}',
